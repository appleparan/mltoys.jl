...
function run_model()
    ...
    train_sdate = ZonedDateTime(2008, 1, 1, 1, 0, tz"Asia/Seoul")
    ...
    train_all_DNN(df, norm_features, norm_prefix, sample_size, sample_size * (length(features) - 1), batch_size, output_size, epoch_size,
